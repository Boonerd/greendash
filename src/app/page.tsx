  ...
  return (
    <div className="animate-fade-in space-y-8 pb-10">
      ...
      <section className="bg-white dark:bg-white/5 text-forest-dark dark:text-cream rounded-[2.5rem] p-8 shadow-xl shadow-gray-200/50 dark:shadow-none border border-white dark:border-white/5 relative overflow-hidden flex flex-col sm:flex-row items-center sm:items-stretch justify-between gap-8 transition-all hover:scale-[1.01] duration-500 group">
        ...
        {/* Right: Image Content */}
        <div className="relative w-48 h-48 sm:w-56 sm:h-56 flex-shrink-0 mt-4 sm:mt-0 bg-gradient-to-br from-cream to-white dark:from-white/5 dark:to-transparent rounded-full flex items-center justify-center border-4 border-white dark:border-white/10 shadow-2xl shadow-gray-200 dark:shadow-none backdrop-blur-sm">
           <Image 
      ...
      <section>
        <h3 className="text-lg font-bold text-forest-dark dark:text-cream mb-5 flex items-center gap-3">
           {t.actions}
           <span className="h-px flex-1 bg-gradient-to-r from-gray-200 to-transparent dark:from-white/10 ml-2"></span>
        </h3>
      ...
      {/* Crop Status Summary */}
      <section className="bg-white dark:bg-white/5 p-8 rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-lg shadow-gray-100 dark:shadow-none transition-colors duration-300">
...
const ActionCard: React.FC<ActionCardProps> = ({ icon, title, subtitle, onClick }) => {
  ...
  return (
    <button 
      onClick={onClick}
      className="bg-white dark:bg-white/5 p-6 rounded-[2rem] text-left transition-all active:scale-95 hover:shadow-xl hover:-translate-y-1 border border-gray-100 dark:border-white/5 flex flex-col justify-between h-44 relative overflow-hidden group shadow-md shadow-gray-100 dark:shadow-none"
    >
