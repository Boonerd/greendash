...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-forest text-white hover:bg-forest-light shadow-lg shadow-forest/20",
    secondary: "bg-lime text-forest-dark hover:bg-lime-hover shadow-lg shadow-lime/20",
    outline: "border-2 border-forest text-forest hover:bg-forest hover:text-white dark:border-cream dark:text-cream dark:hover:bg-cream dark:hover:text-forest",
